...
func EncodeID(encoder Encoder, id int, idType int) string {
	res, _ := encoder.Encode([]int{id, idType})
	return res
}

// EncodeUserID encode users id to hash id
...
// EncodeFileID encode files id to hash id
