...
// server is used to implement files.GreeterServer.
type server struct {
	pb.UnimplementedGreeterServer
}

// SayHello implements files.GreeterServer
...
func main() {
	...
	httpSrv.HandleFunc("/files/header", func(w http.ResponseWriter, r *http.Request) {
