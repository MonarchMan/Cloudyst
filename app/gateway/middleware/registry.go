...
type Registry interface {
	...
	Create(cfg *v1.Middleware) (MiddlewareV2, error)
}
...
func (p *middlewareRegistry) Create(cfg *v1.Middleware) (MiddlewareV2, error) {
...
// Create instantiates a middleware based on `cfg`.
func Create(cfg *v1.Middleware) (MiddlewareV2, error) {
