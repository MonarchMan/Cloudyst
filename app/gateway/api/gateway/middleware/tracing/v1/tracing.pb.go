...
const file_gateway_middleware_tracing_v1_tracing_proto_rawDesc = "" +
	"\n" +
	"+gateway/middleware/tracing/v1/tracing.proto\x12\x1dgateway.middleware.tracing.v1\x1a\x1egoogle/protobuf/duration.proto\"\x86\x02\n" +
	"\aTracing\x12%\n" +
	...
	"\binsecure\x18\x05 \x01(\bH\x02R\binsecure\x88\x01\x01B\n" +
	"\n" +
	"\bendpointB\x0f\n" +
	"\r_sample_ratioB\v\n" +
	"\t_insecureB+Z)gateway/api/gateway/middleware/tracing/v1b\x06proto3"
