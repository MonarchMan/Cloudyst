...
const file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc = "" +
	"\n" +
	"9gateway/middleware/circuitbreaker/v1/circuitbreaker.proto\x12$gateway.middleware.circuitbreaker.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgateway/config/v1/gateway.proto\"\x9a\x03\n" +
	"\x0eCircuitBreaker\x12Y\n" +
	"\rsuccess_ratio\x18\x01 \x01(\v22.gateway.middleware.circuitbreaker.v1.SuccessRatioH\x00R\fsuccessRatio\x12\x16\n" +
	"\x05ratio\x18\x02 \x01(\x03H\x00R\x05ratio\x12Y\n" +
	"\rresponse_data\x18\x03 \x01(\v22.gateway.middleware.circuitbreaker.v1.ResponseDataH\x01R\fresponseData\x12\\\n" +
	"\x0ebackup_service\x18\x04 \x01(\v23.gateway.middleware.circuitbreaker.v1.BackupServiceH\x01R\rbackupService\x12G\n" +
	"\x10assert_condtions\x18\x05 \x03(\v2\x1c.gateway.config.v1.ConditionR\x0fassertCondtionsB\t\n" +
	"\atriggerB\b\n" +
	"\x06action\"0\n" +
	"\x06Header\x12\x10\n" +
	...
	"statusCode\x12D\n" +
	"\x06header\x18\x02 \x03(\v2,.gateway.middleware.circuitbreaker.v1.HeaderR\x06header\x12\x12\n" +
	"\x04body\x18\x03 \x01(\fR\x04body\"H\n" +
	"\rBackupService\x127\n" +
	"\bendpoint\x18\x01 \x01(\v2\x1b.gateway.config.v1.EndpointR\bendpoint\"\x8d\x01\n" +
	"\fSuccessRatio\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\x01R\asuccess\x12\x18\n" +
	"\arequest\x18\x02 \x01(\x05R\arequest\x12\x16\n" +
	"\x06bucket\x18\x03 \x01(\x05R\x06bucket\x121\n" +
	"\x06window\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x06windowB&Z$gateway/middleware/circuitbreaker/v1b\x06proto3"

var (
	file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescOnce sync.Once
	file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescData []byte
)
...
func file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescGZIP() []byte {
	file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescOnce.Do(func() {
		file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc), len(file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc)))
	})
...
var file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_goTypes = []any{
...
func file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_init() {
	...
	file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc), len(file_gateway_middleware_circuitbreaker_v1_circuitbreaker_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
