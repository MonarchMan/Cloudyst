...
const file_gateway_middleware_logging_v1_logging_proto_rawDesc = "" +
	"\n" +
	"+gateway/middleware/logging/v1/logging.proto\x12\x1dgateway.middleware.logging.v1\"\t\n" +
	"\aLoggingB+Z)gateway/api/gateway/middleware/logging/v1b\x06proto3"

var (
	file_gateway_middleware_logging_v1_logging_proto_rawDescOnce sync.Once
	file_gateway_middleware_logging_v1_logging_proto_rawDescData []byte
)
...
func file_gateway_middleware_logging_v1_logging_proto_rawDescGZIP() []byte {
	file_gateway_middleware_logging_v1_logging_proto_rawDescOnce.Do(func() {
		file_gateway_middleware_logging_v1_logging_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_middleware_logging_v1_logging_proto_rawDesc), len(file_gateway_middleware_logging_v1_logging_proto_rawDesc)))
	})
...
var file_gateway_middleware_logging_v1_logging_proto_goTypes = []any{
...
func file_gateway_middleware_logging_v1_logging_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gateway_middleware_logging_v1_logging_proto_rawDesc), len(file_gateway_middleware_logging_v1_logging_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
