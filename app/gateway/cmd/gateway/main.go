...
import (
	...
	"gateway/client"
	"gateway/config"
	configLoader "gateway/config/config-loader"
	"gateway/discovery"
	"gateway/middleware"
	"gateway/proxy"
	"gateway/proxy/debug"
	...
	_ "gateway/discovery/consul"
	_ "gateway/middleware/auth"
	_ "gateway/middleware/bbr"
	"gateway/middleware/circuitbreaker"
	_ "gateway/middleware/cors"
	_ "gateway/middleware/logging"
	_ "gateway/middleware/rewrite"
	_ "gateway/middleware/security"
	_ "gateway/middleware/streamrecorder"
	_ "gateway/middleware/tracing"
	_ "gateway/middleware/transcoder"
...
func main() {
	...
	if err != nil {
		log.Fatalf("failed to create config files loader: %v", err)
	}
