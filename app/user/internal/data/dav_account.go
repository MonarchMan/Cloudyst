...
type (
	DavAccountClient interface {
		...
		// GetByIDAndUserID returns the dav account with given id and users id.
...
func (c *davAccountClient) cursorPagination(ctx context.Context, query *ent.DavAccountQuery, args *ListDavAccountArgs,
	paramMargin int) ([]*ent.DavAccount, *pb.PaginationResults, error) {
