...
type DavAccount struct {
	...
	Props *v1.DavAccountProps `json:"props,omitempty"`
...
func (_m *DavAccount) assignValues(columns []string, values []any) error {
...
func (_m *DavAccount) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// QueryOwner queries the "owner" edge of the DavAccount entity.
func (_m *DavAccount) QueryOwner() *UserQuery {
	return NewDavAccountClient(_m.config).QueryOwner(_m)
}
...
func (_m *DavAccount) Update() *DavAccountUpdateOne {
	return NewDavAccountClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the DavAccount entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *DavAccount) Unwrap() *DavAccount {
...
func (_m *DavAccount) String() string {
