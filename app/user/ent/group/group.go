...
const (
	...
	// FieldStoragePolicyInfo holds the string denoting the storage_policy_info field in the database.
	FieldStoragePolicyInfo = "storage_policy_info"
