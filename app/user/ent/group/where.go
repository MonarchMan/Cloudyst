...
// StoragePolicyInfoIsNil applies the IsNil predicate on the "storage_policy_info" field.
func StoragePolicyInfoIsNil() predicate.Group {
	return predicate.Group(sql.FieldIsNull(FieldStoragePolicyInfo))
}

// StoragePolicyInfoNotNil applies the NotNil predicate on the "storage_policy_info" field.
func StoragePolicyInfoNotNil() predicate.Group {
	return predicate.Group(sql.FieldNotNull(FieldStoragePolicyInfo))
}
