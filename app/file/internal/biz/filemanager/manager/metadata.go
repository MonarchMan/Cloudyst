...
type (
	metadataValidator func(ctx context.Context, m *manager, patch *pb.MetadataPatch) error
)
...
var (
	...
	validateColor = func(optional bool) metadataValidator {
		return func(ctx context.Context, m *manager, patch *pb.MetadataPatch) error {
	...
	validators = map[string]map[string]metadataValidator{
		"sys": {
			wildcardMetadataKey: func(ctx context.Context, m *manager, patch *pb.MetadataPatch) error {
				if patch.Remove {
		...
		"thumb": {
			...
			dbfs.ThumbDisabledKey: func(ctx context.Context, m *manager, patch *pb.MetadataPatch) error {
		...
		customizeMetadataSuffix: {
			...
			emojiIconMetadataKey: func(ctx context.Context, m *manager, patch *pb.MetadataPatch) error {
				patch.UpdateModifiedAt = true
...
func (m *manager) PatchMedata(ctx context.Context, path []*fs.URI, data ...*pb.MetadataPatch) error {
...
func (m *manager) validateMetadata(ctx context.Context, data ...*pb.MetadataPatch) ([]*pb.MetadataPatch, error) {
	validated := make([]*pb.MetadataPatch, 0, len(data))
