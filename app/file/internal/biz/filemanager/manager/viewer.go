...
func (m *manager) CreateViewerSession(ctx context.Context, uri *fs.URI, version string, viewer *ftypes.Viewer) (*ViewerSession, error) {
...
func ViewerFromContext(ctx context.Context) *ftypes.Viewer {
	return ctx.Value(ViewerCtx{}).(*ftypes.Viewer)
}
