...
func (_q *DirectLinkQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DirectLinkQuery) FirstIDX(ctx context.Context) int {
...
func (_q *DirectLinkQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *DirectLinkQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *DirectLinkQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *DirectLinkQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
