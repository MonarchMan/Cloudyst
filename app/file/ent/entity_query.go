...
func (_q *EntityQuery) QueryFile() *FileQuery {
...
func (_q *EntityQuery) QueryStoragePolicy() *StoragePolicyQuery {
...
func (_q *EntityQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *EntityQuery) FirstIDX(ctx context.Context) int {
...
func (_q *EntityQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *EntityQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *EntityQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *EntityQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EntityQuery) Clone() *EntityQuery {
	...
	return &EntityQuery{
		...
		withStoragePolicy: _q.withStoragePolicy.Clone(),
...
func (_q *EntityQuery) WithFile(opts ...func(*FileQuery)) *EntityQuery {
	query := (&FileClient{config: _q.config}).Query()
...
func (_q *EntityQuery) WithStoragePolicy(opts ...func(*StoragePolicyQuery)) *EntityQuery {
	query := (&StoragePolicyClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withStoragePolicy = query
	return _q
}
...
func (_q *EntityQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Entity, error) {
	...
	if query := _q.withStoragePolicy; query != nil {
		if err := _q.loadStoragePolicy(ctx, query, nodes, nil,
...
func (_q *EntityQuery) loadFile(ctx context.Context, query *FileQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *File)) error {
...
func (_q *EntityQuery) loadStoragePolicy(ctx context.Context, query *StoragePolicyQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *StoragePolicy)) error {
