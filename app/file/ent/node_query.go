...
func (_q *NodeQuery) QueryStoragePolicy() *StoragePolicyQuery {
...
func (_q *NodeQuery) WithStoragePolicy(opts ...func(*StoragePolicyQuery)) *NodeQuery {
	query := (&StoragePolicyClient{config: _q.config}).Query()
...
func (_q *NodeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Node, error) {
	...
	if query := _q.withStoragePolicy; query != nil {
		if err := _q.loadStoragePolicy(ctx, query, nodes,
...
func (_q *NodeQuery) loadStoragePolicy(ctx context.Context, query *StoragePolicyQuery, nodes []*Node, init func(*Node), assign func(*Node, *StoragePolicy)) error {
