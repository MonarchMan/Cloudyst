...
type Node struct {
	...
	Settings *v1.NodeSetting `json:"settings,omitempty"`
...
func (_m *Node) QueryStoragePolicy() *StoragePolicyQuery {
	return NewNodeClient(_m.config).QueryStoragePolicy(_m)
}
...
func (_m *Node) String() string {
	...
	builder.WriteString(_m.SlaveKey)
	builder.WriteString(", ")
