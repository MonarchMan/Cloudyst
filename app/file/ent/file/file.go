...
const (
	...
	// FieldOwnerInfo holds the string denoting the owner_info field in the database.
	FieldOwnerInfo = "owner_info"
	...
	// FieldFileParentID holds the string denoting the file_parent_id field in the database.
	FieldFileParentID = "file_parent_id"
	...
	ParentColumn = "file_parent_id"
	// ChildrenTable is the table that holds the children relation/edge.
	ChildrenTable = "files"
	// ChildrenColumn is the table column denoting the children relation/edge.
	ChildrenColumn = "file_parent_id"
...
// ByFileParentID orders the results by the file_parent_id field.
func ByFileParentID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFileParentID, opts...).ToFunc()
}
