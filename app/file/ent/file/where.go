...
// FileParentID applies equality check predicate on the "file_parent_id" field. It's identical to FileParentIDEQ.
func FileParentID(v int) predicate.File {
	return predicate.File(sql.FieldEQ(FieldFileParentID, v))
}
...
func OwnerIDGT(v int) predicate.File {
	return predicate.File(sql.FieldGT(FieldOwnerID, v))
}

// OwnerIDGTE applies the GTE predicate on the "owner_id" field.
func OwnerIDGTE(v int) predicate.File {
	return predicate.File(sql.FieldGTE(FieldOwnerID, v))
}

// OwnerIDLT applies the LT predicate on the "owner_id" field.
func OwnerIDLT(v int) predicate.File {
	return predicate.File(sql.FieldLT(FieldOwnerID, v))
}

// OwnerIDLTE applies the LTE predicate on the "owner_id" field.
func OwnerIDLTE(v int) predicate.File {
	return predicate.File(sql.FieldLTE(FieldOwnerID, v))
}

// OwnerInfoIsNil applies the IsNil predicate on the "owner_info" field.
func OwnerInfoIsNil() predicate.File {
	return predicate.File(sql.FieldIsNull(FieldOwnerInfo))
}

// OwnerInfoNotNil applies the NotNil predicate on the "owner_info" field.
func OwnerInfoNotNil() predicate.File {
	return predicate.File(sql.FieldNotNull(FieldOwnerInfo))
}
...
// FileParentIDEQ applies the EQ predicate on the "file_parent_id" field.
func FileParentIDEQ(v int) predicate.File {
	return predicate.File(sql.FieldEQ(FieldFileParentID, v))
}

// FileParentIDNEQ applies the NEQ predicate on the "file_parent_id" field.
func FileParentIDNEQ(v int) predicate.File {
	return predicate.File(sql.FieldNEQ(FieldFileParentID, v))
}

// FileParentIDIn applies the In predicate on the "file_parent_id" field.
func FileParentIDIn(vs ...int) predicate.File {
	return predicate.File(sql.FieldIn(FieldFileParentID, vs...))
}

// FileParentIDNotIn applies the NotIn predicate on the "file_parent_id" field.
func FileParentIDNotIn(vs ...int) predicate.File {
	return predicate.File(sql.FieldNotIn(FieldFileParentID, vs...))
}

// FileParentIDIsNil applies the IsNil predicate on the "file_parent_id" field.
func FileParentIDIsNil() predicate.File {
	return predicate.File(sql.FieldIsNull(FieldFileParentID))
}

// FileParentIDNotNil applies the NotNil predicate on the "file_parent_id" field.
func FileParentIDNotNil() predicate.File {
	return predicate.File(sql.FieldNotNull(FieldFileParentID))
}
