...
func (*FsEvent) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case fsevent.FieldID, fsevent.FieldUserID:
...
func (_m *FsEvent) assignValues(columns []string, values []any) error {
...
func (_m *FsEvent) Value(name string) (ent.Value, error) {
...
func (_m *FsEvent) Update() *FsEventUpdateOne {
	return NewFsEventClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the FsEvent entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *FsEvent) Unwrap() *FsEvent {
