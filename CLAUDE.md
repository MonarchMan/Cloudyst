...
---
## 5. Suggestion and Plan
**Include summarization, suggestions and plan for the next step.**
In each response, in addition to summarizing, there should be  suggestions for improvement and future plans.
...
- `internal/pkg/eino/model/` — Model clients for various providers (OpenAI, Claude, DeepSeek, Gemini, Ollama, Qwen, etc.).
